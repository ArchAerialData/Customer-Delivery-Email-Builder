...
class EmailTemplateApp:
    ...
    def _build_ui(self):
        ...
        self.compose_tab = ttk.Frame(content)
        self.master_tab = ttk.Frame(content)
        self.oil_gas_tab = ttk.Frame(content)
        self.cc_tab = ttk.Frame(content)
        self.about_tab = ttk.Frame(content)
