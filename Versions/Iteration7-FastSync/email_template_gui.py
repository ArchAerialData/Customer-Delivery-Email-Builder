...
class EmailTemplateApp:
    ...
    def _build_master_tab(self):
        ...
        ttk.Button(btns, text="Reload", command=self._refresh_ui).pack(side="left")
    ...
    def _build_cc_tab(self):
        ...
        ttk.Button(left, text="Reload", command=self._refresh_ui).pack(anchor="w")
    ...
    def _refresh_ui(self):
        ...
        self._reset_cc_tab()
        self._reset_compose_state(refresh_clients=True)
    ...
    def _reset_compose_state(self, refresh_clients: bool = True):
    ...
    def _create_draft(self):
        ...
        try:
            ...
            try:
                ...
                try:
                    # Ensure session is logged on without UI
