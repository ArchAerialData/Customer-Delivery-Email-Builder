...
class EmailTemplateApp:
    ...
    def _build_ui(self):
        ...
        self.oil_gas_tab = ttk.Frame(notebook)
        self.cc_tab = ttk.Frame(notebook)

        notebook.add(self.compose_tab, text="Compose")
        notebook.add(self.master_tab, text="Construction")
        notebook.add(self.oil_gas_tab, text="Oil & Gas")
    ...
    def _build_client_sites_tab(self, parent, sheet_name: str):
        ...
        ttk.Button(btns, text="Add", command=lambda sheet=sheet_name: self._add_master_entry(sheet)).pack(side="left", padx=(0, 6))
